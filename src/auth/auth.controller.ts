import { Controller, Request, Post, UseGuards, Body, HttpCode, HttpStatus, Get, Headers, NotAcceptableException, Res, Param } from '@nestjs/common';
...
export class AuthController {
    ...
    @Public()
    @Post('refresh')
    async refreshToken(@Request() req, @Body() body, @Res() res, @Body('refreshToken') oldRefreshToken: string){
        ...
        const refreshToken = (await this.authService.refreshToken(user)).refresh_token;
